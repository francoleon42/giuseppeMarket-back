...
public class SecurityConfig {
    ...
    private void configureVendedorEndpoints(AuthorizeHttpRequestsConfigurer<HttpSecurity>.AuthorizationManagerRequestMatcherRegistry authRequest) {
        authRequest
                ...
                .requestMatchers(HttpMethod.DELETE, "/impuesto/desasignar").hasRole(VENDEDOR)
                .requestMatchers(HttpMethod.GET, "/impuesto/impuestos_de_producto/{idProducto}").hasRole(VENDEDOR)
                //

                // pree venta epic 1
                .requestMatchers(HttpMethod.GET, "/productos/por_usuario").hasRole(VENDEDOR)
                .requestMatchers(HttpMethod.GET, "/productos/obtener_productos_de_sucursal").hasRole(VENDEDOR)
                ...
                .requestMatchers(HttpMethod.GET, "/caja/obtener_cajas_por_fechas").hasRole(VENDEDOR);
